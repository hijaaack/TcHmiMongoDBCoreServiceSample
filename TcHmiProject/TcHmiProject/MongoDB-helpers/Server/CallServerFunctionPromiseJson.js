...
(function (/** @type {globalThis.TcHmi} */ TcHmi) {
    ...
    (function (/** @type {globalThis.TcHmi.Functions} */ Functions) {
        ...
        (function (TcHmiProject) {
            async function CallServerFunctionPromiseJson(FunctionName, Parameter) {
                return new Promise(function (resolve, reject) {
                    ...
                    TcHmi.Server.request(request, function (data) {
                        ...
                        if (data.error == TcHmi.Errors.NONE && data.results[0].error == TcHmi.Errors.NONE) {
                            return resolve(JSON.parse(data.response.commands[0].readValue));
                        }
            ...
            TcHmiProject.CallServerFunctionPromiseJson = CallServerFunctionPromiseJson;
        })(TcHmiProject = Functions.TcHmiProject || (Functions.TcHmiProject = {}));
    })(Functions = TcHmi.Functions || (TcHmi.Functions = {}));
})(TcHmi);
TcHmi.Functions.registerFunctionEx('CallServerFunctionPromiseJson', 'TcHmi.Functions.TcHmiProject', TcHmi.Functions.TcHmiProject.CallServerFunctionPromiseJson);
